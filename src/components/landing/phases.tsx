      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-[1.75rem] sm:text-[2.25rem] md:text-[2.75rem] font-semibold tracking-[-0.02em] text-foreground leading-[1.12]">
            <span className="font-serif italic text-foreground-secondary">Three phases</span>
        ...
        <div className="relative">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-16 mb-16 md:mb-24">
            <div className="md:text-right">
              ...
              <h3 className="text-[1.5rem] font-semibold tracking-tight text-foreground mb-3">
                Pre-Storm
              </h3>
              <p className="text-[14px] text-foreground-secondary leading-[1.7]">
